...
// This is sample users_chaincode
...
// Location describes chaincode's structure
...
func (t *SimpleChaincode) create(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	//{
	//	//Validating
	//	chaincodeID := "users_chaincode"
	//	invokeArgs := ToChaincodeArgs("get", data.ManagerUserHashes)
	//	response := stub.InvokeChaincode(chaincodeID, invokeArgs, "mainchannel")
	//
	//	if response.Status != shim.OK {
	//		errStr := fmt.Sprintf("Failed to validate %s.", chaincodeID)
	//		return shim.Error(errStr)
	//	}
	//}
	//
	//{
	//	//Validating
	//	chaincodeID := "companies_chaincode"
	//	invokeArgs := ToChaincodeArgs("get", data.CompanyHashes)
	//	response := stub.InvokeChaincode(chaincodeID, invokeArgs, "mainchannel")
	//
	//	if response.Status != shim.OK {
	//		errStr := fmt.Sprintf("Failed to validate %s.", chaincodeID)
